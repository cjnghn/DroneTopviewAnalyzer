...
class FlightRecordTest {
    ...
    void shouldCreateValidFlightRecord() {
        ...
        FlightRecord record = new FlightRecord(1000L, now, 37.5, 127.1, 45.0, 0, true);
        ...
        assertEquals(0, record.compassHeading());
    ...
    void shouldThrowExceptionWhenDateTimeIsNull() {
        assertThrows(IllegalArgumentException.class, () ->
            new FlightRecord(1000L, null, 37.5, 127.1, 45.0, 0, true)
        );
    }
}